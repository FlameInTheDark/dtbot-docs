...
Команда `!help` выводит поощь по командам бота.
...
Аргумент | Тип | Обязательно
---------|:-----:|:---------------:
Ссылка на видео | [Строка](/ru-ru/arguments?id=string) | Да
...
Аргумент | Тип | Обязательно
---------|:-----:|:---------------:
Ссылка на радио | [Строка](/ru-ru/arguments?id=string) | Да
...
Конвертирует одну валюту во вторую.

<!-- tabs:start -->

#### ** Использование **

`!c conv <код_валюты> <код_второй_валюты> <сумма>`
