...
## Ключ станции :id=station-key

Ключ станции это идентификатор станции по которому ее можно воспроизвести.  
Смотрите доступные станции командой [`!r list`](/ru-ru/commands?id=r-list).  
В списке радиостанций слева (то что в квадратных скобках) является ключем.
